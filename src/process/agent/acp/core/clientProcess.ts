...
export const isChildProcessRunning = (child: ChildProcess): boolean =>
  child.exitCode == null && child.signalCode == null;

export function requireAgentStdio(child: ChildProcess): ChildProcessByStdio<Writable, Readable, Readable> {
...
export const asAbsoluteCwd = (cwd: string): string => path.resolve(cwd);

export const basenameToken = (value: string): string =>
  path
    .basename(value)
    .toLowerCase()
